                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        MaterialButton(
                            ...
                            onPressed: () {
                              setState(() {
                                if (resource.opt_A_Text(num) ==
                                    resource.get_correct_answer_Text(num)) {
                                  if (num <
                                      resource._questions_list.length - 1) {
                                    num++;
                                    correct_ans++;
                                  } else {
                                    Navigator.push(
